...
N 420 -200 500 -200 { lab=xxx}
N 500 -200 500 -160 { lab=xxx}
N 420 -160 500 -160 { lab=xxx}
...
C {symbols/lab_pin.sym} 420 -130 0 0 {name=l1 sig_type=std_logic lab=VSSPIN}
