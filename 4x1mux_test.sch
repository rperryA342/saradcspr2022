...
S {}
E {}
N -1040 -540 -1040 -510 { lab=S0}
N -1040 -540 -970 -540 { lab=S0}
N -240 -530 -240 -500 { lab=B2}
N -240 -530 -170 -530 { lab=B2}
N -730 -690 -730 -660 { lab=B3}
N -730 -690 -660 -690 { lab=B3}
N -20 -140 60 -140 {
lab=CompOut}
...
N -410 -140 -350 -140 {
lab=S1}
N -730 -540 -730 -510 { lab=S1}
N -730 -540 -660 -540 { lab=S1}
...
C {symbols/lab_pin.sym} -970 -540 0 1 {name=x22 sig_type=std_logic lab=S0}
...
C {symbols/lab_pin.sym} -660 -690 0 1 {name=x35 sig_type=std_logic lab=B3}
...
C {4x1analogmux.sym} -200 -90 0 0 {name=x1}
C {symbols/lab_pin.sym} -410 -60 0 0 {name=l1 sig_type=std_logic lab=B0}
C {symbols/lab_pin.sym} -410 -120 0 0 {name=l2 sig_type=std_logic lab=B3}
C {symbols/lab_pin.sym} -410 -100 0 0 {name=l5 sig_type=std_logic lab=B2}
C {symbols/lab_pin.sym} -410 -80 0 0 {name=l6 sig_type=std_logic lab=B1}
C {symbols/lab_pin.sym} -410 -40 0 0 {name=l7 sig_type=std_logic lab=S0}
C {symbols/lab_pin.sym} -410 -140 0 0 {name=l9 sig_type=std_logic lab=S1}
C {symbols/vsource.sym} -730 -480 0 0 {name=V1 value="DC 0 pwl (0n 0 \{t0\} 0 \{t0r\} 2 \{t1\} 2 \{t1r\} 0)"}
C {symbols/gnd.sym} -730 -450 0 0 {name=l8 lab=GND}
C {symbols/lab_pin.sym} -660 -540 0 1 {name=x4 sig_type=std_logic lab=S1}
