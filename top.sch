...
N 400 -290 690 -290 { lab=#net1}
N 550 -320 550 -220 { lab=B[2]}
N 550 -330 690 -330 { lab=B[2]}
N 550 -330 550 -320 { lab=B[2]}
N 590 -350 690 -350 { lab=B[1]}
N 590 -350 590 -220 { lab=B[1]}
...
C {symbols/lab_wire.sym} 630 -370 0 0 {name=l9 sig_type=std_logic lab=B[0]}
C {symbols/lab_wire.sym} 590 -350 0 0 {name=l10 sig_type=std_logic lab=B[1]}
C {symbols/lab_wire.sym} 550 -330 0 0 {name=l11 sig_type=std_logic lab=B[2]}
