...
C {sky130_tests/not.sym} 80 210 0 0 {name=x4 m=10 
+ W_N=1 L_N=0.15 W_P=2 L_P=0.15 
+ VCCPIN=VDD VSSPIN=GND}
C {devices/ipin.sym} -40 210 0 0 {name=p1 lab=S}
C {devices/opin.sym} 420 -220 0 0 {name=p4 lab=Vout}
C {devices/ipin.sym} 160 -140 0 0 {name=p5 lab=A1}
C {devices/ipin.sym} 270 -140 0 0 {name=p6 lab=A0}
