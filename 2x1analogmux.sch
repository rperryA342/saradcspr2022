...
N -40 210 40 210 { lab=#net2}
N 210 180 210 260 { lab=#net2}
N -10 260 210 260 { lab=#net2}
N -10 210 -10 260 { lab=#net2}
...
N 210 260 290 260 { lab=#net2}
N 290 180 290 260 { lab=#net2}
C {symbols/dacpassgate.sym} 200 30 3 0 {name=x1}
C {symbols/dacpassgate.sym} 300 30 3 0 {name=x2}
C {symbols/not.sym} 80 210 0 0 {name=x4 m=10 
